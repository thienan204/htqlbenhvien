...
export async function POST(req: NextRequest) {
    try {
        ...
        log(`API Finished. Success: ${successCount}, Skipped: ${skipCount}, Errors: ${errorCount}`);
        return NextResponse.json({ 
            success: true, 
            message: `Processed. Success: ${successCount}, Skipped (duplicate): ${skipCount}, Errors: ${errorCount}` 
        });
